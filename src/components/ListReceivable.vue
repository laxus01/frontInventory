...
export default {
  ...
  methods: {
    async getReceivables() {
      let data = await axios.get("api/transactions/getReceivables");
      let receivable = await data.data.receivables;
      this.desserts = [];
    ...
    save() {
      ...
      this.setPaidReceivable(this.editedItem, id);
    },

    async setPaidReceivable(editedItem, id) {
      axios
        .post(`api/transactions/savePaidReceivable`, {
          id: id,
          receivable_id: editedItem.receivable_id,
